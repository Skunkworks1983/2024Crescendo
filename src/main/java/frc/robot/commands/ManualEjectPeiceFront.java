...
public class ManualEjectPeiceFront extends Command {
  private Collector collector;
  private Indexer indexer;
  private Shooter shooter;

  /** Creates a new MaualEjectPeiceFront. */
  public ManualEjectPeiceFront() {
    this.collector = Collector.getInstance();
    this.indexer = Indexer.getInstance();

    addRequirements(SubsystemGroups.getInstance(Subsystems.ROBOT_INDEXER), SubsystemGroups.getInstance(Subsystems.SHOOTER_FLYWHEEL));

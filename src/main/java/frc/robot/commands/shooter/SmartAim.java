...
public class SmartAim extends Command {
  ...
  public void execute() {
    ...
    //TODO: enable commented out code after sufficient testing.
    ...
    SmartDashboard.putNumber("smart aim rotation set with normal rotation", Units.radiansToDegrees(shooterAngle));

...
public class Shooter extends SubsystemBase {
    ...
    private Shooter() {
        ...
        indexerController = new SmartPIDControllerCANSparkMax(
                Constants.PIDControllers.ShooterIndexerPID.KP,
    ...
    public void setFlywheelSpeed(double speedMetersPerSecond) {
        shootMotor1.setControl(velocityVoltage.withVelocity(
                (speedMetersPerSecond * Constants.Shooter.SHOOTER_ROTATIONS_PER_METER)));

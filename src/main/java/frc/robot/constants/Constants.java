...
public class Constants {
  ...
  public class Collector {
    ...
    public static final double COLLECTOR_FLOOR_POS = 109.5;
  ...
  public class DrivebaseInfo {
    ...
    public class ModuleConstants {
      ...
      public static final SwerveModuleConstants FRONT_RIGHT_MODULE =
          ...
          new SwerveModuleConstants(10, 12, 11, .495283, "Front Right");
  ...
  public class Shooter {
    ...
    public static final double SHOOT_WHEN_READY_SECONDS_BEFORE_SHOOT = 2.5;
  }
  ...
  public class Targeting {
    ...
    public enum FieldTarget {
      ...
      SPEAKER(new Translation3d(-0.1 - Units.feetToMeters(0.6), Units.feetToMeters(18.520833) -.1,
